...
public class PaieUtilsTest {
	...
	@Test
	public void test_formaterBigDecimal_trois_chiffres_apres_la_virgule2() { 
		String resultat = paieUtils.formaterBigDecimal(new BigDecimal("1233.165"));
		assertThat(resultat, equalTo("1233.17"));
	}
